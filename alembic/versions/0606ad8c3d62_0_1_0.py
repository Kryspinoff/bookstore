...
Revision ID: 0606ad8c3d62
Revises: 
Create Date: 2023-01-19 00:11:24.739001
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_authors_fullname'), 'authors', ['fullname'], unique=True)
    ...
    sa.Column('upload', sa.Date(), nullable=True),
    ...
    op.create_index(op.f('ix_pdf_files_book_id'), 'pdf_files', ['book_id'], unique=False)
    ...
    op.create_table('short_pdf_files',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('filename', sa.String(), nullable=True),
    sa.Column('content_type', sa.String(), nullable=True),
    sa.Column('upload', sa.Date(), nullable=True),
    ...
    op.create_index(op.f('ix_short_pdf_files_book_id'), 'short_pdf_files', ['book_id'], unique=False)
    op.create_index(op.f('ix_short_pdf_files_id'), 'short_pdf_files', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_short_pdf_files_id'), table_name='short_pdf_files')
    op.drop_index(op.f('ix_short_pdf_files_book_id'), table_name='short_pdf_files')
    op.drop_table('short_pdf_files')
    ...
    op.drop_index(op.f('ix_pdf_files_book_id'), table_name='pdf_files')
    ...
    op.drop_index(op.f('ix_authors_fullname'), table_name='authors')
